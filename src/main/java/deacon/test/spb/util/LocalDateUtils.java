...
public class LocalDateUtils {
    ...
    public static Date nowDate() {
        return asDate(nowLocalDate());
    }

    // 返回当前日期+时间 dataTime
    public static Date nowDateTime() {
        return asDate(nowLocalDateTime());
    }
     ...
     * @return
     */
    public static boolean checkTimeRange(String updateTime, String timeRanger) {
        return LocalDateUtils.getChronoUnitBetween(LocalDateUtils.parseLocalDateTime(updateTime,
            LocalDateUtils.DATETIME_PATTERN), LocalDateUtils.nowLocalDateTime(), ChronoUnit.MINUTES) < Long.parseLong(
                timeRanger);
    }
